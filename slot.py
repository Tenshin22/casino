...
def cheak_on_win(coins, droppeds_symbols):
    if droppeds_symbols[0] == droppeds_symbols[1] and droppeds_symbols[0] == droppeds_symbols[2]:
        print("+20💸")
        coins += 20
...
def cheak_diagonally(coins, droppeds_symbols_1,
                     droppeds_symbols_2, droppeds_symbols_3):
    if droppeds_symbols_1[2] == droppeds_symbols_2[1] and droppeds_symbols_1[2] == droppeds_symbols_3[0]:
        print("+30💸")
        coins += 30
    elif  droppeds_symbols_1[0] == droppeds_symbols_2[1] and droppeds_symbols_1[0] == droppeds_symbols_3[2]:
        print("+30💸")
        coins += 30
    else:
        print("+0💸")
...
def cheak_vertically(coins, droppeds_symbols_1,
                     droppeds_symbols_2, droppeds_symbols_3):
    if droppeds_symbols_1[0] == droppeds_symbols_2[0] and droppeds_symbols_1[0] == droppeds_symbols_3[0]:
        print("+25💸")
        coins += 25
    elif droppeds_symbols_1[1] == droppeds_symbols_2[1] and droppeds_symbols_1[1] == droppeds_symbols_3[1]:
        print("+25💸")
        coins += 25
    elif droppeds_symbols_1[2] == droppeds_symbols_2[2] and droppeds_symbols_1[2] == droppeds_symbols_3[2]:
        print("+25💸")
        coins += 25
    else:
        print("+0💸")
...
# игра
def play(coins, symbols, list_droppeds_symbols_1, 
         list_droppeds_symbols_2, list_droppeds_symbols_3,
         user_name):
    droppeds_symbols_1 = symbols_cosino(symbols, droppeds_symbols=list_droppeds_symbols_1)
    droppeds_symbols_2 = symbols_cosino(symbols, droppeds_symbols=list_droppeds_symbols_2)
    droppeds_symbols_3 = symbols_cosino(symbols, droppeds_symbols=list_droppeds_symbols_3)
    ...
    coins = cheak_diagonally(coins, droppeds_symbols_1,
                             droppeds_symbols_2, droppeds_symbols_3)


    coins = cheak_vertically(coins, droppeds_symbols_1,
                             droppeds_symbols_2, droppeds_symbols_3)
...
def recording_coins(coins, list_users_coins,
                    list_users_names, user_name):
...
# цикл игры
while True:
    user_choice = int(input("Каждая попытка стоит 15💸\n1.Продолжить\n2.Уйти\nНажмите, цифру: "))
    if coins >= 15 and user_choice == 1:
        coins = coins - 15
        coins = play(coins, symbols, list_droppeds_symbols_1,
                     list_droppeds_symbols_2, list_droppeds_symbols_3,
                     user_name)
    elif user_choice == 2:
        ...
        recording_coins(coins, list_users_coins,
                        list_users_names, user_name)
        exit()
    else:
